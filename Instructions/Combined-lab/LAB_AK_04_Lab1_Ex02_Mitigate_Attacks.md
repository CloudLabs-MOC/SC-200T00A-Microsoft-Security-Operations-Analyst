...
1. A new incident called **Hands-on keyboard attack** appears in the right pane. Select the incident name to load its details.

    ![Picture 1](../Media/lab4-06-19.png)
...
1. Select the **Manage incident** link (with a pencil icon) and a new window blade appears.
    ...
    ![Picture 1](../Media/lab4-06-20.png)
