# Lab 05 - Exercise 2: Mitigate threats using Microsoft Defender for Cloud
...
1. Select **Add filter (1)** and then select **Resource type (2)**.

   ![Picture 1](../Media/14-8-25-l5.png)

1. Select the **Machines - Azure Arc (1)** checkbox and then select the **Apply (2)** button.

   ![Picture 1](../Media/14-8-25-l5-1.png)
...
1. In the `Set owner` **Email address (1)** box, enter **<inject key="AzureAdUserEmail"></inject>** . 
