...
1. Select the Microsoft Sentinel **uniquenameDefender** Workspace.

   ![](../Media/l8e130.png)

1. In the Microsoft Sentinel left navigation menu, scroll down to the **Content management** section and select **Content Hub (1)**.

1. In the **Content hub**, search for the **Common Event Format (2)** solution and select **Common Event Format (3)** from the list.

1. On the **Common Event Format** solution page select **Manage (4)**.
...
1. Select **Next: Collect**. In the **Collect** tab, select the  **LOG_ALERT (1)** drop-down menu, and select **LOG_WARNING (2)**.

   ![](../Media/14-8-25-l4e-7.png)
...
1. Go to the **Content hub (1)** in the data connector window, search for **Syslog (2)**, select **Syslog (3)** from the list and click on **Install (4)**.

   ![](../Media/14-8-25-l4e-9.png)
...
1. In Microsoft Sentinel portal, select **Settings (1)** from **Configuration** area and then select **Workspace settings (2)** from the settings blade.

   ![](../Media/14-8-25-l4e-11.png)

1. On the left menu Select **Legacy agents management (1)** from the **Classic** area.

1. Select the **Syslog (2)** tab.

1. Select the **+ Add facility (3)** button.

   ![](../Media/14-8-25-l4e-12.png)
...
1. Select **Apply (3)**.  You have completed this task.

   ![](../Media/14-8-25-l4e-13.png)
