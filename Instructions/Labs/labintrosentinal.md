# Getting Started with Your Lab: Ingest Logs to Microsoft Sentinel
 
Welcome to your Lab: Ingest Logs to Microsoft Sentinel workshop! We've prepared a seamless environment for you to explore and learn about monitoring, identifying, investigating, and responding to threats in multi-cloud environments. Let's begin by making the most of this experience:

## Accessing Your Lab Environment
 
Once you're ready to dive in, your virtual machine and lab guide will be right at your fingertips within your web browser.
 
 ![Access Your VM and Lab Guide](../Media/sent.png)
...
Click on Next from the lower right corner to move on to the next page.
   ...
   ![Start Your Azure Journey](../Media/next-3.png)
