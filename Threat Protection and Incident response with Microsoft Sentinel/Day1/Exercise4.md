...
1. Select **180 days (1)** for **Analytics retention**. Notice that **Total retention** is only **180 days (2)**, Same as Analytics retention and click on **Save (3)** to apply the changes. 
